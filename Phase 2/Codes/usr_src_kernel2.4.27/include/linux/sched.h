...
/* ======LOTTERY SCHEDULER CONSTANTS (FROM GROUP B)======= */
#define MAX_TICKETS 5      /* A */
#define MIN_TICKETS 1       /* B */
#define LOSE_TICKET_TIME 20 /* C (ms) - lose ticket if on CPU < C ms ago */
#define GAIN_TICKET_TIME 200 /* D (ms) - gain ticket if on CPU > D ms ago */
#define INITIAL_TICKETS 3   /* E */
/*========================================================*/
...
/* ============ LOTTERY SCHEDULER FIELDS ============ */
	unsigned int lottery_tickets;      /* Current ticket count for this process */
	unsigned long last_cpu_time;       /* Last time process was on CPU (jiffies) */
	unsigned int original_tickets;     /* Initial ticket count (E value) */
/* ============ END LOTTERY SCHEDULER FIELDS ============ */
